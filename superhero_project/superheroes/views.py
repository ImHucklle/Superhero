...
def create(request):
    if request.method == "POST":
        ...
        new_hero = Superhero(name=name, alterego=alter_ego, primary_ability=primary, secondary_ability=secondary, catch_phrase=catchphrase)
        new_hero.save()
...
def delete(request, hero_id):
    delete_hero =Superhero.objects.delete(pk=hero_id)
    context = {
